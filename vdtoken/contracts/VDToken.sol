...
contract VDToken is Context, IERC20, Ownable {
    ...
    constructor(
        address _owner,
        address _developmentWalletAddr,
        address _uniswapV2RouterAddr
    ) Ownable(_owner) {
        _rOwned[owner()] = _rTotal;
        _developmentWalletAddress = _developmentWalletAddr;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            // 0x93bcDc45f7e62f89a8e901DC4A0E2c6C427D9F25
            _uniswapV2RouterAddr
        );

        address addr = _uniswapV2Router.factory();

        uniswapV2Pair = IUniswapV2Factory(addr).createPair(
            address(this),
